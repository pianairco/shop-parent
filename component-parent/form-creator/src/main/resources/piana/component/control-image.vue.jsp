<app name="controlImage"></app>

<html-template>
    <div class="form-group">
        <div class="row text-center justify-content-center">
            <div v-if="!item.image" class="col-12 text-center" >
            ...
            <div v-if="item.image" class="btn-group" v-bind:style="{ width: width }">
                <button class="btn btn-success btn-block"
                        style="border-bottom-left-radius: 0px; margin-top: 0px; border-bottom-right-radius: 0px; outline: none; box-shadow: none;"
                        v-on:click="$refs.file.click();"
                        type="button">انتخاب</button>
